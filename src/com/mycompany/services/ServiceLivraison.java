...
public class ServiceLivraison{
    ...
    public boolean addTask(Livraison t) {
        String url = Statics.BASE_URL + "/addLivraisonJSON/new?nom=" + t.getNom() + "&adresse=" + t.getAdresse()+ "&numero=" + t.getNumero()+ "&mail=" + t.getMail()+ "&message=" + t.getMessage(); //création de l'URL
 //création de l'URL
        req.setUrl(url);
        ...
        try {
            ...
            */
            ...
            for(Map<String,Object> obj : list){
                ...
                t.setNom((String)Nom);
                String adressee = (obj.get("adresse").toString());
                t.setAdresse((String)adressee);
    ...
    public ArrayList<Livraison> getAllTasks(){
         String url = Statics.BASE_URL+"/livraison/All";
        req.setUrl(url);
        req.setPost(false); 
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
   ...
   String url =Statics.BASE_URL+"/deleteLivraisonJSON/"+id;
    ...
    public boolean updateLivraison(Livraison t) {
        String url = Statics.BASE_URL + "/updateLivraisonJSON/"+t.getId()+"?nom=" + t.getNom() + "&adresse=" + t.getAdresse()+ "&numero=" + t.getNumero()+ "&mail=" + t.getMail()+ "&message=" + t.getMessage(); //création de l'URL
 //création de l'URL
        req.setUrl(url);
    req.setPost(false); // Insertion de l'URL de notre demande de connexion
        req.addResponseListener(new ActionListener<NetworkEvent>() {
