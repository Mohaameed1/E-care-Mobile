...
public class ListCommentaireForm extends BaseForm{
    ...
    super("Newsfeed", BoxLayout.y());
       ...
       // rbs[0].setSelected(false);
        ...
        RadioButton mesListes = RadioButton.createToggle("Commenter", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Liste reponses", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Mes commentaires", barGroup);
  ...
  liste.addActionListener(l->{
        ...
        ArrayList<Commentaire>list = ServiceCommentaire.getInstance().getAllTasks();
...
if(image.getHeight()>Display.getInstance().getDisplayHeight()/2){
 ...
 public void bindButtonSlection(Button btn ,Label l){
    ...
    private void addButton(Image img,Commentaire rec,Resources res) {
       ...
       Label adressetxt= new Label("sujet :"+rec.getSujet(),"NEWTopLine2");
      
       Label mailtxt= new Label("question :"+rec.getMedecin(),"NEWTopLine2");
        Label numerotxt= new Label("medecin :"+rec.getQuestion(),"NEWTopLine2");
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
               ...
               , BoxLayout.encloseX(numerotxt,lModifier,lSupprimer)));
