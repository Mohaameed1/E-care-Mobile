...
public class ListMedecinForm extends BaseForm{
    ...
    public ListMedecinForm(Resources res) {
    ...
    super("Newsfeed", BoxLayout.y());
       ...
       // rbs[0].setSelected(false);
        ...
        RadioButton partage = RadioButton.createToggle("Les medecins", barGroup);
  ...
  liste.addActionListener(l->{
        ...
        ArrayList<Medecin>list = MedecinService.getInstance().affichageMedecin();
        
        for (Medecin  rec : list){
...
if(image.getHeight()>Display.getInstance().getDisplayHeight()/2){
 ...
 public void bindButtonSlection(Button btn ,Label l){
    ...
    private void addButton(Image img,Medecin rec,Resources res) {
       ...
       //
         createLineSeparator();
           createLineSeparator();
             createLineSeparator();
        Label nomtxt= new Label("nom :"+rec.getNom(),"NEWTopLine2");
       Label prenomtxt= new Label("prenom :"+rec.getPrenom(),"NEWTopLine2");
      
       Label specialitetxt= new Label("specialite :"+rec.getSpecialite(),"NEWTopLine2");
        Label adressetxt= new Label("adresse :"+rec.getAdresse(),"NEWTopLine2");
                Label sexetxt= new Label("sexe :"+rec.getSexe(),"NEWTopLine2");
                        Label cintxt= new Label("cin :"+rec.getCin(),"NEWTopLine2");
                                Label numtxt= new Label("Num :"+rec.getNum_tel(),"NEWTopLine2");
        ...
        if(dig.show("Suppression","Vous voulez supprimer ce medecin ?","Annuler","oui")){
        ...
        if(MedecinService.getInstance().deleteMed(rec.getId()));
        ...
        supprimerStyle.setFgColor(0xf7ad02);
                ...
                lModifier.addPointerPressedListener(l->{
                   ...
                   new ModifierMedForm(res,rec ).show();
