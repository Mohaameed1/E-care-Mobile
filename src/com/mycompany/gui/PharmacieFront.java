...
public Container addItem(Pharmacie e) throws IOException{
   ...
   Label lib_nbr_tel = new Label("Telephone : ");
            ...
            //normalement c'est bon , mazlt famma l9ta sghira , mchklaa ml codeame one 
            //eyh dima fmma mchkla fll google maps 
            //ama nrmlmnt c bon yaatik saha
            //ma ghir mzeya ,bonne chance
            //merci <3
             
            f2.add(lib_nom).add(nomt).add(lib_nbr_tel).add(telt).add(lib_adresse).add(adresset).add(des).add(CR).add(map);
