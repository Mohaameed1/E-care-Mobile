    ...
    super("Newsfeed", BoxLayout.y());
       ...
       // rbs[0].setSelected(false);
        ...
        //  ListReclamationForm a = new ListReclamationForm(res);
          //  a.show();
            new AjouterLivraisonForm(res).show();
        });
        ...
        ArrayList<Livraison>list = ServiceLivraison.getInstance().getAllTasks();
        
        for (Livraison  rec : list){
...
if(image.getHeight()>Display.getInstance().getDisplayHeight()/2){
 ...
 public void bindButtonSlection(Button btn ,Label l){
    ...
    private void addButton(Image img,Livraison rec,Resources res) {
       ...
       Label mailtxt= new Label("mail :"+rec.getMail(),"NEWTopLine2");
        Label numerotxt= new Label("numero :"+rec.getNumero(),"NEWTopLine2");
              Label messagetxt= new Label("message :"+rec.getMessage(),"NEWTopLine2");
        ...
        if(ServiceLivraison.getInstance().deleteLivraison(rec.getId()));
        ...
        supprimerStyle.setFgColor(0xf7ad02);
                ...
                lModifier.addPointerPressedListener(l->{
                   ...
                   new ModifierLivraisonForm(res,rec ).show();
