 ...
 * @author achra
 */
public class AjouterPanierForm extends BaseForm{
    
      Form current;
    
    public AjouterPanierForm(Resources res){
     ...
     //   RadioButton[] rbs = new RadioButton[swipe.getTabCount()];
      ...
      rbs[0].setSelected(true);
        ...
        */
        ...
        RadioButton mesListes = RadioButton.createToggle("Mes paniers", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("List Livraison", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("achat", barGroup);
...
liste.addActionListener(l->{
        ...
        //
        TextField code=new TextField("","entrer code");
        code.setUIID("TexetFieldBlack");
        addStringValue("code",code);
        
           TextField produit=new TextField("","entrer produit");
        produit.setUIID("TexetFieldBlack");
        addStringValue("produit",produit);
        
        
           TextField quantite=new TextField("","entrer quantite");
        quantite.setUIID("TexetFieldBlack");
        ...
        btnAjouter.addActionListener((ActionEvent e) ->{
            try{
                if ((code.getText().length()==0)||(quantite.getText().length()==0)||(produit.getText().length()==0)||(prix.getText().length()==0))
                ...
                Panier p = new Panier();
                                p.setProduits(produit.getText());
                                p.setCode_panier(code.getText());
                                p.setQuantite(Integer.valueOf(quantite.getText()));
                       
                                      
                    System.out.println("data livraison=="+p);
                    ServicePanier.getInstance().addPanier(p);
                iDialog.dispose();
