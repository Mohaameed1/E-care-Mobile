...
import com.mycompany.services.mailing1;
...
public class AjouterCommentaireForm extends BaseForm{
   ...
   super("Newsfeed", BoxLayout.y());
       ...
       // rbs[0].setSelected(false);
        ...
        sujet.setUIID("TexetFieldBlack");
        addStringValue("sujet",sujet);
        
        
           TextField question=new TextField("","entrer question");
        question.setUIID("TexetFieldBlack");
        addStringValue("question",question);
        
        
           TextField medecin=new TextField("","entrer medecin");
        medecin.setUIID("TexetFieldBlack");
        addStringValue("medecin",medecin);
        ...
        btnAjouter.addActionListener((e) ->{
            try{
                if ((pseudo.getText().length()==0)||(sujet.getText().length()==0)||(question.getText().length()==0)||(medecin.getText().length()==0))
                ...
                Commentaire r=new Commentaire(String.valueOf(pseudo.getText())
                .toString(),
                ...
                mailing1.sendEmail("mohamedamorri1@gmail.com","Service Contact ","Commentaire ajouté : ");
                 new ListCommentaireForm(res).show();
