...
class CliniqueController extends AbstractController
{
     ...
     */
    public function getRendezvous(CliniqueRepository $CliniqueRepository , SerializerInterface $SerializerInterface ){
        $Rendezvous=$CliniqueRepository->findAll();
        $json=$SerializerInterface ->serialize($Rendezvous,'json',['groups'=>'Clinique']);
        dump($json);
        die;
